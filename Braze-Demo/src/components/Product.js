...
const Product = () => {
    ...
    const [cart, setCart] = useState(() => {
        ...
        return storedCart ? parseInt(storedCart, 10) : 0; // Default to 0 if no cart is found
    ...
    const closeCart = () => {
        ...
        document.querySelector('.cart-box').classList.remove('cart-box-toggle');

    };
    const openCart = () => {
        document.querySelector('.cart-box').classList.toggle('cart-box-toggle');
        ...
        <button
                ...
                <div ref={myRef1} className="cart-item-div">
                    ...
                    <div className="cart-item-col2">
                        ...
                        Xstream UltraBook 14 - Sleek, Powerful $125.00 x {cart}{" "}
                            <span className="item-amount">${1500 * cart}.00</span>
                        </p>
                    </div>
            ...
            <div className="hero-row">
                ...
                <div className="hero-col hero-col2">
                    <div className="col2-wrapper">
                        <h4 className="hero-subHeading">Hardware Products</h4>
                        <h1 className="main-heading">Xstream UltraBook 14 </h1>
                        <p className="hero-para">
                        The Xstream UltraBook 14 combines cutting-edge performance with a sleek, lightweight design,
                         perfect for on-the-go professionals and students. Equipped with an Intel Core i7 processor, 16GB RAM, and 512GB SSD,
                         it delivers lightning-fast performance for multitasking, content creation, and more. The 14-inch Full HD display offers
                          stunning visuals, while the long-lasting battery ensures you stay productive all day. Weighing just 2.6 lbs, it’s 
                        easy to carry, making it the ideal companion for work, travel, and everything in between.
                        </p>
                        <span className="dollar">$1500.00</span>
                        <span className="discount hero-subHeading">50%</span>
                        <del className="discount2 hero-para">$3000.00</del>
                ...
                >
                  ...
                  <use fill="#FF7E1B" fillRule="nonzero" xlinkHref="#a" />
                                ...
                                >
                                    ...
                                    <use fill="#28a745" fillRule="nonzero" xlinkHref="#b" />
                                </svg>
                            </div>
